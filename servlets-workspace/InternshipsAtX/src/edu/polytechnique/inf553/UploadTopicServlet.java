        ...
        if (errorMessage.equals("None")) {
            ...
            try (Connection con = DbUtils.getInstance().getConnection()) {
                ...
                if (!checkEmail(email)) {
                    ...
                    String query1 = "insert into person(name, email, creation_date, valid, password)" + " values (?, ?, ?, true, crypt(?, gen_salt('bf'))) ;";
                ...
                String query5 = "insert into internship(title, creation_date, content, supervisor_id, scientific_validated, administr_validated, is_taken, program_id, confidential_internship)" + " values (?, ?, ?, ?, false, false, false, ?, ?) ;";
                ...
                if (inputStream != null) {
                    ...
                    try (PreparedStatement ps6 = con.prepareStatement(query6)) {
                        ...
                        try (ResultSet rs6 = ps6.executeQuery()) {
                            ...
                            String query7 = "insert into internship_category(internship_id, category_id)" + " values (?, ?) ;";
